...
export const ResponseDisplay = ({responseMessage, responseError}: {
    ...
    return <div className="row mt-3">
        <div className="col-sm-12">
            ...
            {responseError &&
                <div className="alert alert-warning font-monospace">
                    <div className="row">
                    ...
                    <form onSubmit={handleFormSubmit}>
                        <div className="form-group row mb-3">
                            ...
                            <div className="col-sm-10">
                                <textarea id="payload" name="payload" className="form-control font-monospace" placeholder="Payload"
                        ...
                        <div className="form-group row mb-3">
                            ...
                            <div className="col-sm-10">
                                <input id="delay" name="delay" type="number" className="form-control font-monospace" placeholder="delay"
                                       value={callState.delay} onChange={handleUserInput}/>

                            </div>
                        </div>
                        <div className="form-group row mb-3">
                            <label htmlFor="responseCode" className="col-sm-2 col-form-label">Response Status Code</label>
                            <div className="col-sm-10">
                                <input id="responseCode" name="responseCode" type="number" className="form-control font-monospace"
                        ...
                        <div className="form-group row mb-3">
                            <div className="col-sm-10">
                                <button name="submit" className="btn btn-primary"
                                        disabled={!callState.formValid || callState.loading}>Submit</button>
                            </div>
                        </div>
                    </form>
                </div>
